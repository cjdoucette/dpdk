...
#define RTE_MAX_MEMSEG_PER_LIST (8192 << 3)
#define RTE_MAX_MEM_MB_PER_LIST (32768 << 3)
#define RTE_MAX_MEMSEG_PER_TYPE (32768 << 3)
#define RTE_MAX_MEM_MB_PER_TYPE (65536 << 3)
